...
class PlayerFeatures:
    ...
    Attributes:
        ...
        recent_win_rate: Win rate in recent games (0.0 to 1.0).
        avg_accuracy: Average move accuracy (0.0 to 100.0).
        rating_trend: Rating change over recent games.
        games_last_30d: Games played in last 30 days.
        velocity: Elo change per game over window.
    """
...
class UserGameData:
    ...
    Attributes:
        username: Player username.
        pre_game_elo: Elo before game.
        post_game_elo: Elo after game.
        features: Momentum features.
        velocity: Elo change per game.
        momentum_adjustment: Predicted adjustment for true Elo.
        opponent_elo: Opponent's rating.
        actual_result: Game outcome (1.0 win, 0.5 draw, 0.0 loss).
...
class MatchData:
    ...
    def from_api_response(
        ...
        p1_features = cls._calculate_features(
            p1_username, p1_elo, p1_history, end_time
        )
        p2_features = cls._calculate_features(
            p2_username, p2_elo, p2_history, end_time
        )
